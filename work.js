...
const ruleProviders = {
  proxycidr: {
    ...ruleProviderCommon,
    behavior: "ipcidr",
    url: "https://raw.githubusercontent.com/luofuchang/gfw-rules/refs/heads/master/proxy.txt",
    path: "./ruleset/loyalsoldier/proxycidr.yaml",
  },
  unreachable: {
    ...ruleProviderCommon,
    behavior: "domain",
...
const rules = [
  ...
  "DOMAIN-SUFFIX,19971214.xyz,节点选择", // Github Pages
